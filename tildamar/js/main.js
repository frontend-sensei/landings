(function($, undefined){
    $(function(){
		...
		$('.open-modal').on('click',function(){
			$('.modal-overlay').removeClass('d-n').addClass('d-f');
			$('.modal').removeClass('d-n').addClass('d-f');
			$('.sidenav-overlay').removeClass('active');
			$('.sidenav').removeClass('active');
			$('body').addClass('o-h');
		});
		...
		$('.modal-close').on('click',function(){
			$('.modal-overlay').addClass('d-n').removeClass('d-f');
			$('.modal').addClass('d-n').removeClass('d-f');
			$('body').removeClass('o-h');
		});

		$('.modal-overlay').on('click',function(){
			$(this).addClass('d-n').removeClass('d-f');
			$('.modal').addClass('d-n').removeClass('d-f');
			$('body').removeClass('o-h');
		});
		...
		prev.on('click', function () {
			...
			$('.progress').css({'width': `${(100/7)*(indexOfTab-1)}%`});
